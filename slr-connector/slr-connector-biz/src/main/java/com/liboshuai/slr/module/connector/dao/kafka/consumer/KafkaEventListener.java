package com.liboshuai.slr.module.connector.dao.kafka.consumer;

import com.liboshuai.slr.framework.common.util.json.JsonUtils;
import com.liboshuai.slr.module.connector.convert.AlertMessageConvert;
import com.liboshuai.slr.module.connector.dao.mongo.AlertMessageRepository;
...
public class KafkaEventListener {
    ...
    public void flinkAlertMessage(List<ConsumerRecord<String, String>> consumerRecordList, Acknowledgment ack) {
        ...
        if (!validAlertMessageDTOList.isEmpty()) {
            // 将预警消息批量保存到 MongoDB
            List<AlertMessageMongo> alertMessageMongoList = AlertMessageConvert.INSTANCE
                    .batchConvertDto2Mongo(validAlertMessageDTOList);
            alertMessageRepository.saveAll(alertMessageMongoList);
        }
