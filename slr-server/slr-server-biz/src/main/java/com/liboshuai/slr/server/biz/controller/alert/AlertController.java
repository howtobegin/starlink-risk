...
public class AlertController {
    ...
    public CommonResult<PageResult<AlertRespVO>> page(@RequestBody @Valid AlertPageReqVO alertPageReqVO) {
        PageResult<AlertRespVO> messageRespVOPageResult = alertMessageService.page(alertPageReqVO);
        PageResult<AlertRespVO> alertMessageRespVOPageResult = BeanUtils.toBean(messageRespVOPageResult, AlertRespVO.class);
