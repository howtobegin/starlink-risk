...
import com.liboshuai.slr.server.biz.controller.riskRule.vo.req.*;
import com.liboshuai.slr.server.biz.controller.riskRule.vo.resp.RuleCondRespVO;
import com.liboshuai.slr.server.biz.controller.riskRule.vo.resp.RuleEventAttrValueRespVO;
import com.liboshuai.slr.server.biz.controller.riskRule.vo.resp.RuleInfoRespVO;
import com.liboshuai.slr.server.biz.convert.riskRule.DorisEventConvert;
import com.liboshuai.slr.server.biz.dal.dataobject.riskRule.*;
import com.liboshuai.slr.server.biz.dal.mysql.riskRule.*;
...
public class RuleInfoServiceImpl implements RuleInfoService {
    ...
    public void putCacheRuleInfo(Long ruleCode) {
        ...
        RuleInfoDTO ruleInfoDTO = BeanUtils.toBean(ruleInfoDO, RuleInfoDTO.class);
        multilevelCache.put(RedisKeyConstants.RULE_INFO + RedisKeyConstants.REDIS_KEY_SPLIT + ruleCode, ruleInfoDTO);
    }

    @Override
    public RuleInfoDTO getCacheRuleInfo(Long ruleCode) {
        RuleInfoDTO ruleInfoDTO = multilevelCache.get(
                RedisKeyConstants.RULE_INFO + RedisKeyConstants.REDIS_KEY_SPLIT + ruleCode,
                RuleInfoDTO.class
        );
    ...
    public void refreshCache() {
        ...
        ruleInfoDOList.forEach(ruleInfoDO ->
                multilevelCache.put(
                        RedisKeyConstants.RULE_INFO + RedisKeyConstants.REDIS_KEY_SPLIT + ruleInfoDO.getRuleCode(),
