package com.liboshuai.slr.server.biz.controller.event;
...
public class EventController {
    ...
    public CommonResult<KafkaInfoRespVO> getKafkaInfo() {
        KafkaInfoRespVO kafkaInfoRespVO = eventService.kafkaInfo();
    ...
    public CommonResult<?> push(@RequestBody @Valid KafkaEventGroupReqVO kafkaEventGroupReqVO) {
        eventService.push(kafkaEventGroupReqVO);
        return success();
    }
}
