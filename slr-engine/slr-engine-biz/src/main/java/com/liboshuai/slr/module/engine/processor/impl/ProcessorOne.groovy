...
//     */
//    @Override
//    void init(RuntimeContext runtimeContext, KeyedStateStore keyedStateStore, RuleInfoDTO ruleInfoDTO) {
...
//     */
//    @Override
//    void processElement(String currentKey, long currentEventTimestamp, KafkaEventDTO kafkaEventDTO,
