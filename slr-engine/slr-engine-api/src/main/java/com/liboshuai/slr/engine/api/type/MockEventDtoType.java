...
public class MockEventDtoType extends TypeInfoFactory<MockEventDTO> {
    @Override
    public TypeInformation<MockEventDTO> createTypeInfo(Type type, Map<String, TypeInformation<?>> map) {
        ...
        return Types.POJO(MockEventDTO.class, typeInformationMap);
    }
}
