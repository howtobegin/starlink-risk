...
VALUES (25, 'R1873332239786446848_GAME_userId_lottery', 'CYCLE', 10, '分钟', NULL, NULL, 10, b'0', NULL,
        'R1873332239786446848', 'GAME_userId_lottery', 'system', NULL, '2024-12-30 11:10:51', NULL);
INSERT INTO `slr_rule_cond`
VALUES (30, 'R1873622180391161856_HJF_userId_orderAmount', 'CYCLE', 3, '分钟', NULL, NULL, 100, b'0', NULL,
        'R1873622180391161856', 'HJF_userId_orderAmount', 'system', NULL, '2024-12-30 15:16:44', NULL);
INSERT INTO `slr_rule_cond`
VALUES (31, 'R1873622180391161856_HJF_userId_orderCount', 'CYCLE', 5, '分钟', NULL, NULL, 10, b'0', NULL,
        'R1873622180391161856', 'HJF_userId_orderCount', 'system', NULL, '2024-12-30 15:16:44', NULL);
...
(
    `id`          bigint UNSIGNED                                        NOT NULL AUTO_INCREMENT COMMENT '自增主键ID',
    `event_code`  varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '事件编号',
    `event_field` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '事件字段',
...
(
    ...
    `attr_field` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '属性字段',
...
VALUES (2, 'GAME', 'R1873332239786446848', '游戏高频抽奖', '游戏高频抽奖规则', 'DRAFT', 4, '分钟',
        ...
        NULL, 'GAME_userId', 'M1873324910378618880', 'system', 'system', '2024-12-29 19:36:26', '2024-12-30 11:10:51');
INSERT INTO `slr_rule_info`
VALUES (3, 'HJF', 'R1873622180391161856', '花积分刷单', '花积分刷单规则', 'DRAFT', 2, '分钟',
        '[刷单预警]${KafkaEventDTO.eventAttrMap.HJF_userId_orderAmount_bankName}(${KafkaEventDTO.eventAttrMap.HJF_userId_orderAmount_bankId}): 花积分用户(${KafkaEventDTO.targetValue})，最近${RuleInfoDTO.ruleCondGroup.0.windowValue}${RuleInfoDTO.ruleCondGroup.0.windowUnit}内下单金额为${ProcessorDTO.eventCodeAndValueSumMap.HJF_userId_orderAmount}，超过${RuleInfoDTO.ruleCondGroup.0.threshold}次；且最近${RuleInfoDTO.ruleCondGroup.1.windowValue}${RuleInfoDTO.ruleCondGroup.1.windowUnit}内下单数量为${ProcessorDTO.eventCodeAndValueSumMap.HJF_userId_orderCount}，超过${RuleInfoDTO.ruleCondGroup.1.threshold}次；触发预警的商品为：${KafkaEventDTO.eventAttrMap.HJF_userId_orderAmount_productName}(${KafkaEventDTO.eventAttrMap.HJF_userId_orderAmount_productId})。请您及时查看原因！',
        'AND', 'HJF_userId', 'M1873324910378618880', 'system', 'system', '2024-12-30 14:48:33', '2024-12-30 15:16:44');
...
VALUES (1, 'M1873324910378618880', '模型运算机一', '支持多周期条件、事件属性过滤',
        ...
        'system', 'system', '2024-12-29 19:07:18', '2024-12-30 14:50:12');
...
(
    ...
    `channel`      varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin  NULL DEFAULT NULL COMMENT '渠道',
    `target_code`  varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '目标编号',
    `target_field` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '目标字段',
