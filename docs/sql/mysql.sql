...
-- ----------------------------
INSERT INTO `slr_rule_json` (`id`, `rule_code`, `rule_json`, `creator`, `updater`, `create_time`, `update_time`, `deleted`)
VALUES (1, 'ruleCode01',
...
-- ----------------------------
INSERT INTO slr_rule_model (id, model_code, groovy, version, creator, updater, create_time, update_time, deleted)
