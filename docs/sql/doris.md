...
(
    ...
    `TARGET_FIELD`  VARCHAR(64) NOT NULL COMMENT 'key编号',
...
ENGINE = OLAP
DUPLICATE KEY(`EVENT_TIME`, `TARGET_FIELD`, `TARGET_VALUE`)
PARTITION BY RANGE(`EVENT_TIME`) ()
DISTRIBUTED BY HASH(`EVENT_TIME`, `TARGET_FIELD`, `TARGET_VALUE`) BUCKETS AUTO
PROPERTIES
(
